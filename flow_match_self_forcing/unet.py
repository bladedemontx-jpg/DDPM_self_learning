#! -*- coding: utf-8 -*-
# ============================================================================
# Flow Matching + Self-Forcing 的U-Net模型定义
# ============================================================================
# 【模型结构】
#   与flow_match/FlowMatchUNet完全相同:
#   - SinusoidalTimeEmbedding(连续时间) + MLP
#   - Pre-Norm + Concatenation跳跃连接
#   改进仅在训练策略（见train.py），模型结构本身无变化
#
# 结合了Flow Matching的连续ODE框架与Self-Forcing的训练策略
# ============================================================================
