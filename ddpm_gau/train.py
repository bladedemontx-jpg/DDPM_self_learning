#! -*- coding: utf-8 -*-
# ============================================================================
# 生成扩散模型DDPM参考代码 (PyTorch版) - GAU架构
# ============================================================================
# 【架构改进】用GAU (Gated Attention Unit) 替代U-Net
#   - 训练流程和噪声调度与ddpm基线完全相同
#   - 仅模型架构不同：GAU代替U-Net卷积
#   - 相同的DDPM理论:
#     前向: x_t = ᾱ_t·x_0 + β̄_t·ε
#     训练: L = E[||ε - ε_θ(x_t, t)||_2²]
#     采样: x_{t-1} = (x_t - β_t²/β̄_t·ε_θ) / α_t + σ_t·z
#
